...
function center(){
 ...
 let pricingLine = $('.s-pricing').find('.pricing-line').width();
 if($(window).width() <= pricingLine){
     let result = (pricingLine - windowWidth) / 2;
     console.log(result);
     $('.s-pricing').find('.pricing-line').css('right', result);
 }
}
function repeat(){
    window.setInterval(floatingIcons, 15);
}
function floatingIcons(){

  // $(".icons-carousel").find("a").click(function(){
    console.log("rand");
    let rand = Math.ceil(Math.random() * 100 - 50);
    let select = Math.ceil((Math.random() * 10) % 7 - 1);
    console.log("rand = " + rand);
    console.log("select = " + select);
    let al = $(".icons-carousel").find("a").eq(select);
    // console.log("a = " + al);
    // $(this).animate({
    let method = Math.ceil((Math.random() * 10) % 4 - 1);
    console.log("method = " + method);
    switch(method){
        case 0:
            al.stop(true).animate({
                left: "+=" + rand
            }, 1000);
...
function hidePopup(){
    $("#back-black").fadeOut(100);
    $("#popup-order").fadeOut(100);
}

function showPopup(){
    var height = $(".main-page").height();
    $("#back-black").height(height).fadeIn(100);
    $("#popup-order").fadeIn(100).css("display", "inline-block");
}
function popup(){
    $(".h-header").find("#main-button").click(function(){
        showPopup();
    });
    $("#back-black").click(function(){
        hidePopup();
    });
    $("#popup-order").find("#times").click(function(){
        hidePopup();
    });
}
